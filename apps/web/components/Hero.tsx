      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 leading-normal text-gray-500 text-xl dark:text-gray-300">
              Realty connects property owners needing construction funds with
              investors seeking fractional ownership. Earn monthly rental yields
              from your shares, and benefit from property appreciation, all
              without substantial capital.
            </p>

            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <button className="shadow-[0_4px_14px_0_rgb(0,118,255,39%)] hover:shadow-[0_6px_20px_rgba(0,118,255,23%)] hover:bg-[rgba(0,102,255,0.88)] px-8 py-2 bg-[#0070f3] rounded-md text-white font-light transition duration-200 ease-linear hover:scale-105">
                <Link
                  href="/properties"
